	...
	<form name="form" method="post" action="ServiceEditOk.jsp?pageNum=<%= pageNum %>">
		...
		<table>
			...
			<tr class="text-center">
				<td>
					<textarea class="form-control" style="resize: none;" rows="20" cols="80" name="s_content"><%= s_content %></textarea>
				</td>
			</tr>
			<tr class="text-center">
				<td>
					<input class="btn btn-default" type="button" value="수정하기" onclick="check_ok()">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
