      ...
      <table border="1" width="800" cellspacing="0">
         ...
         <tr height="30">
            <td colspan="4" align="right">
               ...
               %>
               <input type="button" value="글수정" class="btn btn-primary" onclick="location.href='noticeUpdate.jsp?n_id=<%=n_id %>'">
               <input type="button" value="글삭제" class="btn btn-primary" onclick="location.href='noticeDeleteOk.jsp?n_id=<%=n_id %>'">
               <input type="button" value="글작성" class="btn btn-primary" onclick="location.href='noticeWrite.jsp?n_id=<%=n_id %>'">
               <input type="button" value="글목록" class="btn btn-primary" onclick="location.href='Notice_list.jsp?'">
